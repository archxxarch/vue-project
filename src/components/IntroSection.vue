    ...
    <section id="intro">
        <div class="intro__inner">
            ...
            <div class="intro__text">
                <div class="text">
                    <div>Shoot for the moon.</div>
                    <div>even if you miss,</div>
                    <div>It'll land among the stars.</div>
                </div>
                <div class="img">
                </div>
            </div>
...
.intro__text .img {
    ...
    width: 15vw;
    height: 15vw;
    background-image: url(https://images.unsplash.com/photo-1581822261290-991b38693d1b?auto=format&fit=crop&q=80&w=1470&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D);
...
@media (max-width: 800px) {
    ...
    .intro__text .text>div:nth-child(2) {
