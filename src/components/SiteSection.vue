...
.site__title {
    ...
    color: var(--white200);
    border-bottom: 0.4vw solid var(--white200);
    margin-bottom: 100px;
}
...
.site__item.s1 {
    background-color: var(--subBox100);
    top: 180px;
}

.site__item.s2 {
    background-color: var(--subBox200);
    top: 200px;
}

.site__item.s3 {
    background-color: var(--subBox300);
    top: 220px;
}

.site__item.s4 {
    background-color: var(--subBox400);
    top: 240px;
}
